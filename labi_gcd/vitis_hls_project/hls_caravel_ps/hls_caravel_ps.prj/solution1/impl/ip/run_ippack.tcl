...
set Library     "hls"
set IPName      "caravel_ps"
set Version     "0.0"
set DisplayName "Caravel_ps"
set Revision    "1"
...
set xo_kernel_name "caravel_ps"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ubuntu/lab/SoC-Lab-lab5/labi_gcd/vitis_hls_project/hls_caravel_ps/hls_caravel_ps.prj/solution1"
set debug_dir "/home/ubuntu/lab/SoC-Lab-lab5/labi_gcd/vitis_hls_project/hls_caravel_ps/hls_caravel_ps.prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {caravel_ps_control_s_axi
caravel_ps
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 ps_mprj_in_1 W 0x0 "Data signal of ps_mprj_in" {{0 32 ps_mprj_in W 0 "Bit 31 to 0 of ps_mprj_in"}}} {0x14 ps_mprj_in_2 W 0x0 "Data signal of ps_mprj_in" {{0 6 ps_mprj_in W 0 "Bit 37 to 32 of ps_mprj_in"} {6 26 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c ps_mprj_out_1 R 0x0 "Data signal of ps_mprj_out" {{0 32 ps_mprj_out R 0 "Bit 31 to 0 of ps_mprj_out"}}} {0x20 ps_mprj_out_2 R 0x0 "Data signal of ps_mprj_out" {{0 6 ps_mprj_out R 0 "Bit 37 to 32 of ps_mprj_out"} {6 26 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 ps_mprj_out_ctrl R 0x0 "Control signal of ps_mprj_out" {{0 1 ps_mprj_out_ap_vld R 0 "Control signal ps_mprj_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 ps_mprj_en_1 R 0x0 "Data signal of ps_mprj_en" {{0 32 ps_mprj_en R 0 "Bit 31 to 0 of ps_mprj_en"}}} {0x38 ps_mprj_en_2 R 0x0 "Data signal of ps_mprj_en" {{0 6 ps_mprj_en R 0 "Bit 37 to 32 of ps_mprj_en"} {6 26 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c ps_mprj_en_ctrl R 0x0 "Control signal of ps_mprj_en" {{0 1 ps_mprj_en_ap_vld R 0 "Control signal ps_mprj_en_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 1 latency 0 II 1}
...
source -notrace "/tools/Xilinx/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
